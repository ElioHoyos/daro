...
class PensionesController extends Controller
{
    ...
    {
       $pagados = pensiones::where([["Mes","=",MONTH],["Estado",1],["Anio",YEAR]])->get()->count();
       $nopagados = pensiones::where([["Mes","<=",MONTH],["Estado",0],["Anio",YEAR]])->get()->count();
       return compact("pagados","nopagados");
    }
