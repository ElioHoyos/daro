					...
					<div class="card-body">
                        <fieldset class="border p-2">
                            ...
                            <div class="form-group row" id="dni">  
                                ...
                                <div class="col-md-6">
                                    <v-select v-model="zcobrador" :options="cobradores" :value="cobradores.code"> </v-select>
                                </div>
                            </div>  
...
<script>
    ...
    methods: {
		...
		addPrestamo ()
		{
            ...
            this.prestamo.cobrador = this.zcobrador.code;
