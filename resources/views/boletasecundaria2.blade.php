        ...
        <div class="row">
            <table border="1" cellpadding="0" cellspacing="0" class="text-center" style="font-size: 9px">
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[1][1])}}</td>
                    <td>{{addZeros($b2[1][1])}}</td>
                    <td>{{addZeros($b3[1][1])}}</td>
                    <td>{{addZeros($b4[1][1])}}</td>
                    <td rowspan="5" style="font-size: 16px">{{addZeros($aritmeticaProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de regularidad.</td>
                    <td>{{addZeros($b1[1][2])}}</td>
                    
                    <td>{{addZeros($b2[1][2])}}</td>
                    
                    <td>{{addZeros($b3[1][2])}}</td>
                    
                    <td>{{addZeros($b4[1][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de forma y mov.</td>
                    <td>{{addZeros($b1[1][3])}}</td>
                    
                    <td>{{addZeros($b2[1][3])}}</td>
                    
                    <td>{{addZeros($b3[1][3])}}</td>
                    
                    <td>{{addZeros($b4[1][3])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de gestión.</td>
                    <td>{{addZeros($b1[1][4])}}</td>
                    
                    <td>{{addZeros($b2[1][4])}}</td>
                    
                    <td>{{addZeros($b3[1][4])}}</td>
                    
                    <td>{{addZeros($b4[1][4])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($aritmetica1)}}</b></td>
                    
                    <td><b>{{addZeros($aritmetica2)}}</b></td>
                    
                    <td><b>{{addZeros($aritmetica3)}}</b></td>
                    
                    <td><b>{{addZeros($aritmetica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="5"><b>ÁLGEBRA</b></td>
                    <td class="text-left">Piensa matemáticamente situaciones de cantidad.</td>
                    <td>{{addZeros($b1[2][1])}}</td>
                    
                    <td>{{addZeros($b2[2][1])}}</td>
                    
                    <td>{{addZeros($b3[2][1])}}</td>
                    
                    <td>{{addZeros($b4[2][1])}}</td>
                    
                    <td rowspan="5" style="font-size: 16px">{{addZeros($algebraProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de regularidad.</td>
                    <td>{{addZeros($b1[2][2])}}</td>
                    
                    <td>{{addZeros($b2[2][2])}}</td>
                    
                    <td>{{addZeros($b3[2][2])}}</td>
                    
                    <td>{{addZeros($b4[2][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de forma y mov.</td>
                    <td>{{addZeros($b1[2][3])}}</td>
                    
                    <td>{{addZeros($b2[2][3])}}</td>
                    
                    <td>{{addZeros($b3[2][3])}}</td>
                    
                    <td>{{addZeros($b4[2][3])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de gestión.</td>
                    <td>{{addZeros($b1[2][4])}}</td>
                    
                    <td>{{addZeros($b2[2][4])}}</td>
                    
                    <td>{{addZeros($b3[2][4])}}</td>
                    
                    <td>{{addZeros($b4[2][4])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($algebra1)}}</b></td>
                    
                    <td><b>{{addZeros($algebra2)}}</b></td>
                    
                    <td><b>{{addZeros($algebra3)}}</b></td>
                    
                    <td><b>{{addZeros($algebra4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="5"><b>GEOMETRÍA</b></td>
                    <td class="text-left">Piensa matemáticamente situaciones de cantidad.</td>
                    <td>{{addZeros($b1[3][1])}}</td>
                    
                    <td>{{addZeros($b2[3][1])}}</td>
                    
                    <td>{{addZeros($b3[3][1])}}</td>
                    
                    <td>{{addZeros($b4[3][1])}}</td>
                    
                    <td rowspan="5" style="font-size: 16px">{{addZeros($geometriaProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de regularidad.</td>
                    <td>{{addZeros($b1[3][2])}}</td>
                    
                    <td>{{addZeros($b2[3][2])}}</td>
                    
                    <td>{{addZeros($b3[3][2])}}</td>
                    
                    <td>{{addZeros($b4[3][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de forma y mov.</td>
                    <td>{{addZeros($b1[3][3])}}</td>
                    
                    <td>{{addZeros($b2[3][3])}}</td>
                    
                    <td>{{addZeros($b3[3][3])}}</td>
                    
                    <td>{{addZeros($b4[3][3])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de gestión.</td>
                    <td>{{addZeros($b1[3][4])}}</td>
                    
                    <td>{{addZeros($b2[3][4])}}</td>
                    
                    <td>{{addZeros($b3[3][4])}}</td>
                    
                    <td>{{addZeros($b4[3][4])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($geometria1)}}</b></td>
                    
                    <td><b>{{addZeros($geometria2)}}</b></td>
                    
                    <td><b>{{addZeros($geometria3)}}</b></td>
                    
                    <td><b>{{addZeros($geometria4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="5"><b>RAZ.<br>MATEMÁTICO</b></td>
                    <td class="text-left">Piensa matemáticamente situaciones de cantidad.</td>
                    <td>{{addZeros($b1[5][1])}}</td>
                    <td>{{addZeros($b2[5][1])}}</td>
                    <td>{{addZeros($b3[5][1])}}</td>
                    <td>{{addZeros($b4[5][1])}}</td>
                    <td rowspan="5" style="font-size: 16px">{{addZeros($rmProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de regularidad.</td>
                    <td>{{addZeros($b1[5][2])}}</td>
                    <td>{{addZeros($b2[5][2])}}</td>
                    <td>{{addZeros($b3[5][2])}}</td>
                    <td>{{addZeros($b4[5][2])}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de forma y mov.</td>
                    <td>{{addZeros($b1[5][3])}}</td>
                    <td>{{addZeros($b2[5][3])}}</td>
                    <td>{{addZeros($b3[5][3])}}</td>
                    <td>{{addZeros($b4[5][3])}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de gestión.</td>
                    <td>{{addZeros($b1[5][4])}}</td>
                    <td>{{addZeros($b2[5][4])}}</td>
                    <td>{{addZeros($b3[5][4])}}</td>
                    <td>{{addZeros($b4[5][4])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($rm1)}}</b></td>
                    <td><b>{{addZeros($rm2)}}</b></td>
                    <td><b>{{addZeros($rm3)}}</b></td>
                    <td><b>{{addZeros($rm4)}}</b></td>
                </tr>
                <tr class="fondo">
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[6][1])}}</td>
                    
                    <td>{{addZeros($b2[6][1])}}</td>
                    
                    <td>{{addZeros($b3[6][1])}}</td>
                    
                    <td>{{addZeros($b4[6][1])}}</td>
                    
                    <td rowspan="4" style="font-size: 16px">{{addZeros($rvProm)}}</td>
                    {{-- <td rowspan="15" style="font-size: 16px">{{addZeros($comunicacionProm}}</td> --}}
                    {{-- <td rowspan="15" style="font-size: 16px"></td> --}}
                </tr>
                <tr>
                    <td class="text-left">Se expresa oralmente</td>
                    <td>{{addZeros($b1[6][2])}}</td>
                    
                    <td>{{addZeros($b2[6][2])}}</td>
                    
                    <td>{{addZeros($b3[6][2])}}</td>
                    
                    <td>{{addZeros($b4[6][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Comprende textos escritos</td>
                    <td>{{addZeros($b1[6][3])}}</td>
                    
                    <td>{{addZeros($b2[6][3])}}</td>
                    
                    <td>{{addZeros($b3[6][3])}}</td>
                    
                    <td>{{addZeros($b4[6][3])}}</td>
                    
                </tr>
              
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($rv1)}}</b></td>
                    
                    <td><b>{{addZeros($rv2)}}</b></td>
                    
                    <td><b>{{addZeros($rv3)}}</b></td>
                    
                    <td><b>{{addZeros($rv4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="4"><b>PLAN <br> LECTOR</b></td>
                    <td class="text-left">Comprende textos orales</td>
                    <td>{{addZeros($b1[7][1])}}</td>
                    <td>{{addZeros($b2[7][1])}}</td>
                    <td>{{addZeros($b3[7][1])}}</td>
                    <td>{{addZeros($b4[7][1])}}</td>
                    <td rowspan="4" style="font-size: 16px">{{addZeros($plProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Se expresa oralmente</td>
                    <td>{{addZeros($b1[7][2])}}</td>
                    <td>{{addZeros($b2[7][2])}}</td>
                    <td>{{addZeros($b3[7][2])}}</td>
                    <td>{{addZeros($b4[7][2])}}</td>
                </tr>
                <tr>
                    <td class="text-left">Comprende textos escritos</td>
                    <td>{{addZeros($b1[7][3])}}</td>
                    <td>{{addZeros($b2[7][3])}}</td>
                    <td>{{addZeros($b3[7][3])}}</td>
                    <td>{{addZeros($b4[7][3])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($pl1)}}</b></td>
                    <td><b>{{addZeros($pl2)}}</b></td>
                    <td><b>{{addZeros($pl3)}}</b></td>
                    <td><b>{{addZeros($pl4)}}</b></td>
                </tr>
                <tr>
                    <td class="text-center" rowspan="4"><b>LENGUAJE</b></td>
                    <td class="text-left">Comprende textos orales</td>
                    <td>{{addZeros($b1[8][1])}}</td>
                    <td>{{addZeros($b2[8][1])}}</td>
                    <td>{{addZeros($b3[8][1])}}</td>
                    <td>{{addZeros($b4[8][1])}}</td>
                    <td rowspan="4" style="font-size: 16px">{{addZeros($lenguajeProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Se expresa oralmente</td>
                    <td>{{addZeros($b1[8][2])}}</td>
                    <td>{{addZeros($b2[8][2])}}</td>
                    <td>{{addZeros($b3[8][2])}}</td>
                    <td>{{addZeros($b4[8][2])}}</td>
                </tr>
                <tr>
                    <td class="text-left">Comprende textos escritos</td>
                    <td>{{addZeros($b1[8][3])}}</td>
                    <td>{{addZeros($b2[8][3])}}</td>
                    <td>{{addZeros($b3[8][3])}}</td>
                    <td>{{addZeros($b4[8][3])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($lenguaje1)}}</b></td>
                    <td><b>{{addZeros($lenguaje2)}}</b></td>
                    <td><b>{{addZeros($lenguaje3)}}</b></td>
                    <td><b>{{addZeros($lenguaje4)}}</b></td>
                </tr>
                <tr class="fondo">
                ...
                <tr>
                    ...
                    <td class="text-left">Comprende textos orales</td>
                    <td>{{addZeros($b1[10][1])}}</td>
                    <td>{{addZeros($b2[10][1])}}</td>
                    <td>{{addZeros($b3[10][1])}}</td>
                    <td>{{addZeros($b4[10][1])}}</td>
                    <td rowspan="4" style="font-size: 16px">{{addZeros($inglesProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                </tr>
                <tr>
                    <td class="text-left">Se expresa oralmente</td>
                    <td>{{addZeros($b1[10][2])}}</td>
                    <td>{{addZeros($b2[10][2])}}</td>
                    <td>{{addZeros($b3[10][2])}}</td>
                    <td>{{addZeros($b4[10][2])}}</td>
                </tr>
                <tr>
                    <td class="text-left">Comprende textos escritos</td>
                    <td>{{addZeros($b1[10][3])}}</td>
                    <td>{{addZeros($b2[10][3])}}</td>
                    <td>{{addZeros($b3[10][3])}}</td>
                    <td>{{addZeros($b4[10][3])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($ingles1)}}</b></td>
                    <td><b>{{addZeros($ingles2)}}</b></td>
                    <td><b>{{addZeros($ingles3)}}</b></td>
                    <td><b>{{addZeros($ingles4)}}</b></td>
                </tr>
                <tr class="fondo">
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[11][1])}}</td>
                    
                    <td>{{addZeros($b2[11][1])}}</td>
                    
                    <td>{{addZeros($b3[11][1])}}</td>
                    
                    <td>{{addZeros($b4[11][1])}}</td>
                    
                    <td rowspan="3">{{addZeros($arteProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
              
                </tr>
                <tr>
                    <td class="text-left">Apreciación artística</td>
                    <td>{{addZeros($b1[11][2])}}</td>
                    
                    <td>{{addZeros($b2[11][2])}}</td>
                    
                    <td>{{addZeros($b3[11][2])}}</td>
                    
                    <td>{{addZeros($b4[11][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($arte1)}}</b></td>
                    
                    <td><b>{{addZeros($arte2)}}</b></td>
                    
                    <td><b>{{addZeros($arte3)}}</b></td>
                    
                    <td><b>{{addZeros($arte4)}}</b></td>
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[12][1])}}</td>
                    <td>{{addZeros($b2[12][1])}}</td>
                    <td>{{addZeros($b3[12][1])}}</td>
                    <td>{{addZeros($b4[12][1])}}</td>
                    <td rowspan="4" style="font-size: 16px">{{addZeros($historiapProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                </tr>
                <tr>
                    <td class="text-left">Actua responsablemente en el ambiente</td>
                    <td>{{addZeros($b1[12][2])}}</td>
                    <td>{{addZeros($b2[12][2])}}</td>
                    <td>{{addZeros($b3[12][2])}}</td>
                    <td>{{addZeros($b4[12][2])}}</td>
                </tr>
                <tr>
                    <td class="text-left">Actua responsablemente respecto a los recursos econ.</td>
                    <td>{{addZeros($b1[12][3])}}</td>
                    <td>{{addZeros($b2[12][3])}}</td>
                    <td>{{addZeros($b3[12][3])}}</td>
                    <td>{{addZeros($b4[12][3])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($historiap1)}}</b></td>
                    <td><b>{{addZeros($historiap2)}}</b></td>
                    <td><b>{{addZeros($historiap3)}}</b></td>
                    <td><b>{{addZeros($historiap4)}}</b></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[15][1])}}</td>
                    <td>{{addZeros($b2[15][1])}}</td>
                    <td>{{addZeros($b3[15][1])}}</td>
                    <td>{{addZeros($b4[15][1])}}</td>
                    <td rowspan="3">{{addZeros($civicaProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                </tr>
                <tr>
                    <td class="text-left">participa en los asuntos públicos promoviendo el bien común</td>
                    <td>{{addZeros($b1[15][2])}}</td>
                    <td>{{addZeros($b2[15][2])}}</td>
                    <td>{{addZeros($b3[15][2])}}</td>
                    <td>{{addZeros($b4[15][2])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($civica1)}}</b></td>
                    
                    <td><b>{{addZeros($civica2)}}</b></td>
                    
                    <td><b>{{addZeros($civica3)}}</b></td>
                    
                    <td><b>{{addZeros($civica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td rowspan="3"><b>PFRH (PSICOLOGÍA - <br>FILOSOFÍA)</b></td>
                    <td class="text-left">Afirma su identidad</td>
                    <td>{{addZeros($b1[16][1])}}</td>
                    
                    <td>{{addZeros($b2[16][1])}}</td>
                    
                    <td>{{addZeros($b3[16][1])}}</td>
                    
                    <td>{{addZeros($b4[16][1])}}</td>
                    
                    <td rowspan="3">{{addZeros($pfrhProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    {{-- <td rowspan="4">{{addZeros($pfrhProm}}</td> --}}
                    {{--  --}}
                </tr>
                <tr>
                    <td class="text-left">Construye su corporeidad</td>
                    <td>{{addZeros($b1[16][2])}}</td>
                    
                    <td>{{addZeros($b2[16][2])}}</td>
                    
                    <td>{{addZeros($b3[16][2])}}</td>
                    
                    <td>{{addZeros($b4[16][2])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($pfrh1)}}</b></td>
                    
                    <td><b>{{addZeros($pfrh2)}}</b></td>
                    
                    <td><b>{{addZeros($pfrh3)}}</b></td>
                    
                    <td><b>{{addZeros($pfrh4)}}</b></td>
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[17][1])}}</td>
                    
                    <td>{{addZeros($b2[17][1])}}</td>
                    
                    <td>{{addZeros($b3[17][1])}}</td>
                    
                    <td>{{addZeros($b4[17][1])}}</td>
                    
                    <td rowspan="3">{{addZeros($efProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                </tr>
                <tr>
                    <td class="text-left">Dominio corporal y expresión creativa</td>
                    <td>{{addZeros($b1[17][2])}}</td>
                    
                    <td>{{addZeros($b2[17][2])}}</td>
                    
                    <td>{{addZeros($b3[17][2])}}</td>
                    
                    <td>{{addZeros($b4[17][2])}}</td>
                    
                </tr>
                
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($ef1)}}</b></td>
                    
                    <td><b>{{addZeros($ef2)}}</b></td>
                    
                    <td><b>{{addZeros($ef3)}}</b></td>
                    
                    <td><b>{{addZeros($ef4)}}</b></td>
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[18][1])}}</td>
                    
                    <td>{{addZeros($b2[18][1])}}</td>
                    
                    <td>{{addZeros($b3[18][1])}}</td>
                    
                    <td>{{addZeros($b4[18][1])}}</td>
                    
                    <td rowspan="3">{{addZeros($erProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    {{-- <td rowspan="3">{{addZeros($erProm}}</td> --}}
                    {{--  --}}
                </tr>
                <tr>
                    <td class="text-left">Dicernimiento de la fé</td>
                    <td>{{addZeros($b1[18][2])}}</td>
                    
                    <td>{{addZeros($b2[18][2])}}</td>
                    
                    <td>{{addZeros($b3[18][2])}}</td>
                    
                    <td>{{addZeros($b4[18][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($er1)}}</b></td>
                    
                    <td><b>{{addZeros($er2)}}</b></td>
                    
                    <td><b>{{addZeros($er3)}}</b></td>
                    
                    <td><b>{{addZeros($er4)}}</b></td>
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[19][1])}}</td>
                    
                    <td>{{addZeros($b2[19][1])}}</td>
                    
                    <td>{{addZeros($b3[19][1])}}</td>
                    
                    <td>{{addZeros($b4[19][1])}}</td>
                    
                    <td rowspan="4" style="font-size: 16px">{{addZeros($fisicaProm)}}</td>
                    
                    {{-- <td rowspan="15" style="font-size: 16px">{{addZeros($cienciasProm}}</td> --}}
                    {{-- <td rowspan="15" style="font-size: 16px"></td> --}}
                </tr>
                <tr>
                    <td class="text-left">Explica el mundo físico</td>
                    <td>{{addZeros($b1[19][2])}}</td>
                    
                    <td>{{addZeros($b2[19][2])}}</td>
                    
                    <td>{{addZeros($b3[19][2])}}</td>
                    
                    <td>{{addZeros($b4[19][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Diseña y produce prototipos tecnológicos</td>
                    <td>{{addZeros($b1[19][3])}}</td>
                    
                    <td>{{addZeros($b2[19][3])}}</td>
                    
                    <td>{{addZeros($b3[19][3])}}</td>
                    
                    <td>{{addZeros($b4[19][3])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($fisica1)}}</b></td>
                    
                    <td><b>{{addZeros($fisica2)}}</b></td>
                    
                    <td><b>{{addZeros($fisica3)}}</b></td>
                    
                    <td><b>{{addZeros($fisica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="4"><b>QUÍMICA</b></td>
                    <td class="text-left">Indaga mediante métodos científicos</td>
                    <td>{{addZeros($b1[20][1])}}</td>
                    
                    <td>{{addZeros($b2[20][1])}}</td>
                    
                    <td>{{addZeros($b3[20][1])}}</td>
                    
                    <td>{{addZeros($b4[20][1])}}</td>
                    
                    <td rowspan="4" style="font-size: 16px">{{addZeros($quimicaProm)}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Explica el mundo físico</td>
                    <td>{{addZeros($b1[20][2])}}</td>
                    
                    <td>{{addZeros($b2[20][2])}}</td>
                    
                    <td>{{addZeros($b3[20][2])}}</td>
                    
                    <td>{{addZeros($b4[20][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Diseña y produce prototipos tecnológicos</td>
                    <td>{{addZeros($b1[20][3])}}</td>
                    
                    <td>{{addZeros($b2[20][3])}}</td>
                    
                    <td>{{addZeros($b3[20][3])}}</td>
                    
                    <td>{{addZeros($b4[20][3])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($quimica1)}}</b></td>
                    
                    <td><b>{{addZeros($quimica2)}}</b></td>
                    
                    <td><b>{{addZeros($quimica3)}}</b></td>
                    
                    <td><b>{{addZeros($quimica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="4"><b>BIOLOGÍA</b></td>
                    <td class="text-left">Indaga mediante métodos científicos</td>
                    <td>{{addZeros($b1[21][1])}}</td>
                    
                    <td>{{addZeros($b2[21][1])}}</td>
                    
                    <td>{{addZeros($b3[21][1])}}</td>
                    
                    <td>{{addZeros($b4[21][1])}}</td>
                    
                    <td rowspan="4" style="font-size: 16px">{{addZeros($biologiaProm)}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Explica el mundo físico</td>
                    <td>{{addZeros($b1[21][2])}}</td>
                    
                    <td>{{addZeros($b2[21][2])}}</td>
                    
                    <td>{{addZeros($b3[21][2])}}</td>
                    
                    <td>{{addZeros($b4[21][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Diseña y produce prototipos tecnológicos</td>
                    <td>{{addZeros($b1[21][3])}}</td>
                    
                    <td>{{addZeros($b2[21][3])}}</td>
                    
                    <td>{{addZeros($b3[21][3])}}</td>
                    
                    <td>{{addZeros($b4[21][3])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($biologia1)}}</b></td>
                    
                    <td><b>{{addZeros($biologia2)}}</b></td>
                    
                    <td><b>{{addZeros($biologia3)}}</b></td>
                    
                    <td><b>{{addZeros($biologia4)}}</b></td>
                ...
                <tr>
                    ...
                    <td>{{addZeros($b1[22][1])}}</td>
                    
                    <td>{{addZeros($b2[22][1])}}</td>
                    
                    <td>{{addZeros($b3[22][1])}}</td>
                    
                    <td>{{addZeros($b4[22][1])}}</td>
                    
                    <td rowspan="2">{{addZeros($eptProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                     <!-- CALIFICACIÓN DEL PERIODO -->
                ...
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{addZeros($ept1)}}</b></td>
                    
                    <td><b>{{addZeros($ept2)}}</b></td>
                    
                    <td><b>{{addZeros($ept3)}}</b></td>
                    
                    <td><b>{{addZeros($ept4)}}</b></td>
