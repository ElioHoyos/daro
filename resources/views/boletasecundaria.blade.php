...
<body>
    @php
        ...
        //rm
            ...
            $b1[4][3] = isset($notasb1[4][3]) ? $notasb1[4][3] : "";
            $b1[4][4] = isset($notasb1[4][4]) ? $notasb1[4][4] : ""; 
            $rm1 = promedio(array($b1[4][1],$b1[4][2],$b1[4][3],$b1[4][4])); 
            $b2[4][1] = isset($notasb2[4][1]) ? $notasb2[4][1] : "";
            $b2[4][2] = isset($notasb2[4][2]) ? $notasb2[4][2] : "";
            $b2[4][3] = isset($notasb2[4][3]) ? $notasb2[4][3] : "";
            $b2[4][4] = isset($notasb2[4][4]) ? $notasb2[4][4] : "";
            $rm2 = promedio(array($b2[4][1],$b2[4][2],$b2[4][3],$b2[4][4])); 
            $b3[4][1] = isset($notasb3[4][1]) ? $notasb3[4][1] : "";
            $b3[4][2] = isset($notasb3[4][2]) ? $notasb3[4][2] : "";
            $b3[4][3] = isset($notasb3[4][3]) ? $notasb3[4][3] : "";
            $b3[4][4] = isset($notasb3[4][4]) ? $notasb3[4][4] : "";
            $rm3 = promedio(array($b3[4][1],$b3[4][2],$b3[4][3],$b3[4][4])); 
            
            $b4[4][1] = isset($notasb4[4][1]) ? $notasb4[4][1] : "";
            $b4[4][2] = isset($notasb4[4][2]) ? $notasb4[4][2] : "";
            $b4[4][3] = isset($notasb4[4][3]) ? $notasb4[4][3] : "";
            $b4[4][4] = isset($notasb4[4][4]) ? $notasb4[4][4] : "";
            $rm4 = promedio(array($b4[4][1],$b4[4][2],$b4[4][3],$b4[4][4])); 
            $rmProm = promedio(array($rm1,$rm2,$rm3,$rm4)); 
            $mateProm = promedio(array($aritmeticaProm,$algebraProm,$geometriaProm,$rmProm));
        //rv
            ...
            $rv1 = promedio(array($b1[5][1],$b1[5][2],$b1[5][3],$b1[5][4])); 
            ...
            $rv2 = promedio(array($b2[5][1],$b2[5][2],$b2[5][3],$b2[5][4])); 
            ...
            $rv3 = promedio(array($b3[5][1],$b3[5][2],$b3[5][3],$b3[5][4])); 
            ...
            $rv4 = promedio(array($b4[5][1],$b4[5][2],$b4[5][3],$b4[5][4])); 
        ...
        //planlector
            ...
            $pl1 = promedio(array($b1[6][1],$b1[6][2],$b1[6][3],$b1[6][4])); 
            ...
            $pl2 = promedio(array($b2[6][1],$b2[6][2],$b2[6][3],$b2[6][4])); 
            ...
            $pl3 = promedio(array($b3[6][1],$b3[6][2],$b3[6][3],$b3[6][4])); 
            ...
            $pl4 = promedio(array($b4[6][1],$b4[6][2],$b4[6][3],$b4[6][4])); 
        ...
        //lenguaje
            ...
            $lenguaje1 = promedio(array($b1[7][1],$b1[7][2],$b1[7][3],$b1[7][4])); 
            ...
            $lenguaje2 = promedio(array($b2[7][1],$b2[7][2],$b2[7][3],$b2[7][4])); 
            ...
            $lenguaje3 = promedio(array($b3[7][1],$b3[7][2],$b3[7][3],$b3[7][4])); 
            ...
            $lenguaje4 = promedio(array($b4[7][1],$b4[7][2],$b4[7][3],$b4[7][4])); 
            $lenguajeProm = promedio(array($lenguaje1,$lenguaje2,$lenguaje3,$lenguaje4)); 
        //literatura
            $comunicacionProm = promedio(array($rvProm,$lenguajeProm,$plProm));
        //ingles
            ...
            $ingles1   = promedio(array($b1[8][1],$b1[8][2],$b1[8][3],$b1[8][4])); 
            ...
            $ingles2   = promedio(array($b2[8][1],$b2[8][2],$b2[8][3],$b2[8][4])); 
            ...
            $ingles3   = promedio(array($b3[8][1],$b3[8][2],$b3[8][3],$b3[8][4])); 
            ...
            $ingles4   = promedio(array($b4[8][1],$b4[8][2],$b4[8][3],$b4[8][4])); 
        ...
        //historia peru
            ...
            $sociales1  = promedio(array($b1[10][1],$b1[10][2],$b1[10][3],$b1[10][4])); 
            ...
            $sociales2  = promedio(array($b2[10][1],$b2[10][2],$b2[10][3],$b2[10][4])); 
            ...
            $sociales3  = promedio(array($b3[10][1],$b3[10][2],$b3[10][3],$b3[10][4])); 
        ...
        //educ para el trabajo
            ...
            $b1[18][3] = isset($notasb1[18][3]) ? $notasb1[18][3] : "";
            $ept1      = promedio(array($b1[18][1],$b1[18][2],$b1[18][3])); 
            $b2[18][1] = isset($notasb2[18][1]) ? $notasb2[18][1] : "";
            $b2[18][2] = isset($notasb2[18][2]) ? $notasb2[18][2] : "";
            $b2[18][3] = isset($notasb2[18][3]) ? $notasb2[18][3] : "";
            $ept2      = promedio(array($b2[18][1],$b2[18][2],$b2[18][3])); 
            $b3[18][1] = isset($notasb3[18][1]) ? $notasb3[18][1] : "";
            $b3[18][2] = isset($notasb3[18][2]) ? $notasb3[18][2] : "";
            $b3[18][3] = isset($notasb3[18][3]) ? $notasb3[18][3] : "";
            $ept3      = promedio(array($b3[18][1],$b3[18][2],$b3[18][3])); 
            $b4[18][1] = isset($notasb4[18][1]) ? $notasb4[18][1] : "";
            $b4[18][2] = isset($notasb4[18][2]) ? $notasb4[18][2] : "";
            $b4[18][3] = isset($notasb4[18][3]) ? $notasb4[18][3] : "";
            $ept4      = promedio(array($b4[18][1],$b4[18][2],$b4[18][3])); 
            $eptProm   = promedio(array($ept1,$ept2,$ept3,$ept4)); 
    @endphp
    <div class="container-fluid">
        <table class="text-center centrartabla">
            <tr>
                <td rowspan="2" style="vertical-align: middle"><img src="img/escudo.png" height="100" width="100" alt="" srcset=""></td>
                <td class="texto text-center t60 negrita">BOLETA</td>
                <td rowspan="2" style="vertical-align: middle"><img src="images/logo1.png" height="40" width="150" alt="" srcset=""></td>
            </tr>
            <tr>
       ...
       <div style="page-break-after:always;"></div>
        <div class="row">
            <table border="1" cellpadding="0" cellspacing="0" class="text-center" style="font-size: 9px">
                ...
                <tr>
                    <td class="text-center" rowspan="5"><b>ARITMÉTICA</b></td>
                    ...
                    <td rowspan="5" style="font-size: 16px">{{literal($aritmeticaProm)}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b>{{literal($aritmetica1)}}</b></td>
                    <td><b>{{literal($aritmetica2)}}</b></td>
                    <td><b>{{literal($aritmetica3)}}</b></td>
                    <td><b>{{literal($aritmetica4)}}</b></td>
                </tr>
                <tr>
                    <td class="text-center" rowspan="5"><b>ÁLGEBRA</b></td>
                    <td class="text-left">Piensa matemáticamente situaciones de cantidad.</td>
                    <td>{{literal($b1[2][1])}}</td>
                    <td>{{literal($b2[2][1])}}</td>
                    <td>{{literal($b3[2][1])}}</td>
                    <td>{{literal($b4[2][1])}}</td>
                    <td rowspan="5" style="font-size: 16px">{{literal($algebraProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de regularidad.</td>
                ...
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($algebra1)}}</b></td>
                    <td><b>{{literal($algebra2)}}</b></td>
                    <td><b>{{literal($algebra3)}}</b></td>
                    <td><b>{{literal($algebra4)}}</b></td>
                </tr>
                <tr>
                    <td class="text-center" rowspan="5"><b>GEOMETRÍA</b></td>
                    <td class="text-left">Piensa matemáticamente situaciones de cantidad.</td>
                    <td>{{literal($b1[3][1])}}</td>
                    <td>{{literal($b2[3][1])}}</td>
                    <td>{{literal($b3[3][1])}}</td>
                    <td>{{literal($b4[3][1])}}</td>
                    <td rowspan="5" style="font-size: 16px">{{literal($geometriaProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de regularidad.</td>
                ...
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de gestión.</td>
                    <td>{{literal($b1[3][4])}}</td>
                    <td>{{literal($b2[3][4])}}</td>
                    <td>{{literal($b3[3][4])}}</td>
                    <td>{{literal($b4[3][4])}}</td>
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($geometria1)}}</b></td>
                    <td><b>{{literal($geometria2)}}</b></td>
                    <td><b>{{literal($geometria3)}}</b></td>
                    <td><b>{{literal($geometria4)}}</b></td>
                </tr>
                ...
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de gestión.</td>
                    <td>{{literal($b1[4][4])}}</td>
                    
                    <td>{{literal($b2[4][4])}}</td>
                    
                    <td>{{literal($b3[4][4])}}</td>
                    
                    <td>{{literal($b4[4][4])}}</td>
                ...
                <tr>
                    ...
                    <td class="text-center" rowspan="4"><b>RAZ. <br> VERBAL</b></td>
                    ...
                    <td rowspan="4" style="font-size: 16px">{{$rvProm}}</td>
                    {{-- <td rowspan="15" style="font-size: 16px">{{$comunicacionProm}}</td> --}}
                ...
                <tr>
                    <td class="text-center" rowspan="4"><b>PLAN <br> LECTOR</b></td>
                    <td class="text-left">Comprende textos orales</td>
                ...
                <tr>
                    <td class="text-center" rowspan="4"><b>LENGUAJE</b></td>
                    <td class="text-left">Comprende textos orales</td>
                    ...
                    <td rowspan="4" style="font-size: 16px">{{literal($lenguajeProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Se expresa oralmente</td>
                ...
                <tr>
                    <td class="text-left">Comprende textos escritos</td>
                    <td>{{literal($b1[7][3])}}</td>
                    
                    <td>{{literal($b2[7][3])}}</td>
                    
                    <td>{{literal($b3[7][3])}}</td>
                    
                    <td>{{literal($b4[7][3])}}</td>
                    
                </tr>
                
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($lenguaje1)}}</b></td>
                    
                    <td><b>{{literal($lenguaje2)}}</b></td>
                    
                    <td><b>{{literal($lenguaje3)}}</b></td>
                    
                    <td><b>{{literal($lenguaje4)}}</b></td>
                ...
                <tr>
                    ...
                    <td rowspan="4" style="font-size: 16px">{{literal($inglesProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                ...
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($ingles1)}}</b></td>
                    
                    <td><b>{{literal($ingles2)}}</b></td>
                    
                    <td><b>{{literal($ingles3)}}</b></td>
                    
                    <td><b>{{literal($ingles4)}}</b></td>
                ...
                <tr>
                    ...
                    <td>{{literal($b4[9][1])}}</td>
                     ...
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    <td rowspan="3">{{literal($arteProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                ...
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($arte1)}}</b></td>
                    
                    <td><b>{{literal($arte2)}}</b></td>
                    
                    <td><b>{{literal($arte3)}}</b></td>
                    
                    <td><b>{{literal($arte4)}}</b></td>
                ...
                <tr>
                    ...
                    <td class="text-center" rowspan="4"><b>CIENCIAS SOCIALES</b></td>
                    ...
                    <td>{{literal($b4[10][1])}}</td>
                     ...
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    <td rowspan="4" style="font-size: 16px">{{literal($socialesProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                    {{-- <td rowspan="5">{{$socialesProm}}</td> --}}
                    {{-- <td rowspan="5">{{""}}</td> --}}
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{{literal($b1[10][3])}}</td>
                    
                    <td>{{literal($b2[10][3])}}</td>
                    
                    <td>{{literal($b3[10][3])}}</td>
                    
                    <td>{{literal($b4[10][3])}}</td>
                    
                </tr>
                
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($sociales1)}}</b></td>
                    
                    <td><b>{{literal($sociales2)}}</b></td>
                    
                    <td><b>{{literal($sociales3)}}</b></td>
                    
                    <td><b>{{literal($sociales4)}}</b></td>
                    
                </tr>
                
                <tr class="fondo">
                    <td style="  height:17px">CC.SS</td>
                    <td style="  height:17px">CALIFICACIÓN DEL BIMESTRE</td>
                    <td style="  height:17px">{{literal($sociales1)}}</td>
                    
                    <td style="  height:17px">{{literal($sociales2)}}</td>
                    
                    <td style="  height:17px">{{literal($sociales3)}}</td>
                    
                    <td style="  height:17px">{{literal($sociales4)}}</td>
                    
                    
                    <td style="  height:17px">{{literal($socialesProm)}}</td>
                </tr>
                <tr>
                    <td rowspan="3"><b>FORMACIÓN<br> CIUDADANA <br>Y CÍVICA</b></td>
                    ...
                    <td>{{literal($b4[11][1])}}</td>
                     ...
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    <td rowspan="3">{{literal($civicaProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                ...
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($civica1)}}</b></td>
                    
                    <td><b>{{literal($civica2)}}</b></td>
                    
                    <td><b>{{literal($civica3)}}</b></td>
                    
                    <td><b>{{literal($civica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td rowspan="3"><b>PFRH (PSICOLOGÍA - <br>FILOSOFÍA)</b></td>
                    ...
                    <td>{{literal($b4[12][1])}}</td>
                     ...
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    <td rowspan="3">{{literal($pfrhProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                    {{-- <td rowspan="4">{{$pfrhProm}}</td> --}}
                    {{--  --}}
                </tr>
                <tr>
                    <td class="text-left">Construye su corporeidad</td>
                    <td>{{literal($b1[12][2])}}</td>
                    
                    <td>{{literal($b2[12][2])}}</td>
                    
                    <td>{{literal($b3[12][2])}}</td>
                    
                    <td>{{literal($b4[12][2])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($pfrh1)}}</b></td>
                    
                    <td><b>{{literal($pfrh2)}}</b></td>
                    
                    <td><b>{{literal($pfrh3)}}</b></td>
                    
                    <td><b>{{literal($pfrh4)}}</b></td>
                    
                </tr>
                <tr class="fondo">
                    <td style="  height:17px">DPCC</td>
                    <td style="  height:17px">CALIFICACIÓN DEL BIMESTRE</td>
                    ...
                    <td style="  height:17px"></td>
                    <td style="  height:17px"></td>
                    <td style="  height:17px">{{$dpccProm}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{{literal($b1[13][2])}}</td>
                    
                    <td>{{literal($b2[13][2])}}</td>
                    
                    <td>{{literal($b3[13][2])}}</td>
                    
                    <td>{{literal($b4[13][2])}}</td>
                    
                </tr>
                
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($ef1)}}</b></td>
                    
                    <td><b>{{literal($ef2)}}</b></td>
                    
                    <td><b>{{literal($ef3)}}</b></td>
                    
                    <td><b>{{literal($ef4)}}</b></td>
                ...
                <tr>
                    <td rowspan="3"><b>EDUCACIÓN <br>RELIGIOSA</b></td>
                    <td class="text-left">Comprensión doctrinal cristiana</td>
                    <td>{{literal($b1[14][1])}}</td>
                    
                    <td>{{literal($b2[14][1])}}</td>
                    
                    <td>{{literal($b3[14][1])}}</td>
                    
                    <td>{{literal($b4[14][1])}}</td>
                    
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    <td rowspan="3">{{literal($erProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                    {{-- <td rowspan="3">{{$erProm}}</td> --}}
                    {{--  --}}
                </tr>
                <tr>
                    <td class="text-left">Dicernimiento de la fé</td>
                    <td>{{literal($b1[14][2])}}</td>
                    
                    <td>{{literal($b2[14][2])}}</td>
                    
                    <td>{{literal($b3[14][2])}}</td>
                    
                    <td>{{literal($b4[14][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($er1)}}</b></td>
                    
                    <td><b>{{literal($er2)}}</b></td>
                    
                    <td><b>{{literal($er3)}}</b></td>
                    
                    <td><b>{{literal($er4)}}</b></td>
                ...
                <tr>
                    ...
                    <td class="text-center" rowspan="4"><b>FÍSICA</b></td>
                    <td class="text-left">Indaga mediante métodos científicos</td>
                    <td>{{literal($b1[15][1])}}</td>
                    
                    <td>{{literal($b2[15][1])}}</td>
                    
                    <td>{{literal($b3[15][1])}}</td>
                    
                    <td>{{literal($b4[15][1])}}</td>
                    
                    
                    <td rowspan="4" style="font-size: 16px">{{literal($fisicaProm)}}</td>
                    {{-- <td rowspan="15" style="font-size: 16px">{{$cienciasProm}}</td> --}}
                    {{-- <td rowspan="15" style="font-size: 16px"></td> --}}
                </tr>
                <tr>
                    <td class="text-left">Explica el mundo físico</td>
                    <td>{{literal($b1[15][2])}}</td>
                    
                    <td>{{literal($b2[15][2])}}</td>
                    
                    <td>{{literal($b3[15][2])}}</td>
                    
                    <td>{{literal($b4[15][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Diseña y produce prototipos tecnológicos</td>
                    <td>{{literal($b1[15][3])}}</td>
                    
                    <td>{{literal($b2[15][3])}}</td>
                    
                    <td>{{literal($b3[15][3])}}</td>
                    
                    <td>{{literal($b4[15][3])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($fisica1)}}</b></td>
                    
                    <td><b>{{literal($fisica2)}}</b></td>
                    
                    <td><b>{{literal($fisica3)}}</b></td>
                    
                    <td><b>{{literal($fisica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="4"><b>QUÍMICA</b></td>
                    <td class="text-left">Indaga mediante métodos científicos</td>
                    <td>{{literal($b1[16][1])}}</td>
                    
                    <td>{{literal($b2[16][1])}}</td>
                    
                    <td>{{literal($b3[16][1])}}</td>
                    
                    <td>{{literal($b4[16][1])}}</td>
                    
                    
                    <td rowspan="4" style="font-size: 16px">{{literal($quimicaProm)}}</td>
                </tr>
                <tr>
                    <td class="text-left">Explica el mundo físico</td>
                    <td>{{literal($b1[16][2])}}</td>
                    
                    <td>{{literal($b2[16][2])}}</td>
                    
                    <td>{{literal($b3[16][2])}}</td>
                    
                    <td>{{literal($b4[16][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Diseña y produce prototipos tecnológicos</td>
                    <td>{{literal($b1[16][3])}}</td>
                    
                    <td>{{literal($b2[16][3])}}</td>
                    
                    <td>{{literal($b3[16][3])}}</td>
                    
                    <td>{{literal($b4[16][3])}}</td>
                    
                </tr>
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($quimica1)}}</b></td>
                    
                    <td><b>{{literal($quimica2)}}</b></td>
                    
                    <td><b>{{literal($quimica3)}}</b></td>
                    
                    <td><b>{{literal($quimica4)}}</b></td>
                    
                </tr>
                <tr>
                    <td class="text-center" rowspan="4"><b>BIOLOGÍA</b></td>
                    <td class="text-left">Indaga mediante métodos científicos</td>
                    <td>{{literal($b1[17][1])}}</td>
                    
                    <td>{{literal($b2[17][1])}}</td>
                    
                    <td>{{literal($b3[17][1])}}</td>
                    
                    <td>{{literal($b4[17][1])}}</td>
                    
                    <td rowspan="4" style="font-size: 16px">{{literal($biologiaProm)}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Explica el mundo físico</td>
                    <td>{{literal($b1[17][2])}}</td>
                    
                    <td>{{literal($b2[17][2])}}</td>
                    
                    <td>{{literal($b3[17][2])}}</td>
                    
                    <td>{{literal($b4[17][2])}}</td>
                    
                </tr>
                <tr>
                    <td class="text-left">Diseña y produce prototipos tecnológicos</td>
                    <td>{{literal($b1[17][3])}}</td>
                    
                    <td>{{literal($b2[17][3])}}<}/td>
                    
                    <td>{{literal($b3[17][3])}}<}/td>
                    
                    <td>{{literal($b4[17][3])}}<}/td>
                    
                </tr>}
               
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($biologia1)}}</b></td>
                    
                    <td><b>{{literal($biologia2)}}</b></td>
                    
                    <td><b>{{literal($biologia3)}}</b></td>
                    
                    <td><b>{{literal($biologia4)}}</b></td>
                    
                </tr>
                <tr class="fondo">
                    <td style="height: 17px">CYA</td>
                    <td style="height: 17px">CALIFICACIÓN DEL BIMESTRE</td>
                    <td style="height: 17px"></td>
                    <td style="height: 17px"></td>
                    <td style="height: 17px"></td>
                ...
                <tr>
                    <td rowspan="2"><b>EDUCACIÓN<br>PARA EL<br>TRABAJO </b></td>
                    <td class="text-left">Gestión de procesos</td>
                    <td>{{literal($b1[18][1])}}</td>
                    
                    <td>{{literal($b2[18][1])}}</td>
                    
                    <td>{{literal($b3[18][1])}}</td>
                    
                    <td>{{literal($b4[18][1])}}</td>
                    
                     <!-- CALIFICACIÓN DEL PERIODO -->
                    <td rowspan="2">{{literal($eptProm)}}</td> <!-- CALIFICACIÓN DEL PERIODO -->
                    {{-- <td rowspan="4">{{$eptProm}}</td> --}}
                    {{--  --}}
                </tr>
                <tr>
                    <td class="text-left"><b>CALIFICACIÓN DEL PERIODO</b></td>
                    <td><b>{{literal($ept1)}}</b></td>
                    
                    <td><b>{{literal($ept2)}}</b></td>
                    
                    <td><b>{{literal($ept3)}}</b></td>
                    
                    <td><b>{{literal($ept4)}}</b></td>
                    
                </tr>
                <tr class="fondo">
                    <td style="height: 17px">EXT</td>
                    <td style="height: 17px">CALIFICACIÓN DEL BIMESTRE</td>
                    <td style="height: 17px">{{literal($ept1)}}</td>
                   
                    <td style="height: 17px">{{literal($ept2)}}</td>
                   
                    <td style="height: 17px">{{literal($ept3)}}</td>
                   
                    <td style="height: 17px">{{literal($ept4)}}</td>
                   
                   
                    <td style="height: 17px">{{literal($eptProm)}}</td>
                </tr>
            </table>
        </div>
        {{-- <div style="page-break-after:always;"></div> --}}
